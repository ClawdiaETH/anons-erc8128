...
export const ANONS_TOKEN_ADDRESS =
  "0x1ad890FCE6cB865737A3411E7d04f1F5668b0686" as const;
...
export function createAnonsAuth(config: AuthConfig = {}) {
  ...
  // The library expects: (args: { address, message: { raw: Hex }, signature: Hex }) => Promise<boolean>
  const verifyMessageFn = async (args: {
    address: Address;
